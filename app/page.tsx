  ...
  return (
    <div>
      <div className="px-4 pt-20 text-center">
        <h1 className="text-4xl font-extrabold tracking-normal capitalize">{siteConfig.name}</h1>
        <p className="mx-auto mt-4 max-w-6xl text-base">{siteConfig.description}</p>
      </div>
      <div>
